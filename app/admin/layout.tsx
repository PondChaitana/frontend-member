...
export default function AdminLayout({
  ...
  useEffect(() => {
    ...
    // If user is not logged in OR role is not admin, redirect to home page
  ...
  // Don't render until authorization is verified
  if (!isAuthorized) {
    return <div style={{ minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', background: 'var(--background)' }}><div className="spinner"></div></div>;
  }
      ...
      <aside className={`admin-sidebar ${sidebarOpen ? 'open' : ''}`}>
        <div className="sidebar-header">
          <div className="sidebar-logo">
            ...
            <div>
              ...
              <p className="sidebar-subtitle">จัดการระบบ</p>
            </div>
          </div>
        ...
        <div className="sidebar-footer">
          <button 
            ...
            onClick={async () => {
              const { logoutUser } = await import('@/app/lib/api');
              await logoutUser();
              router.push('/');
            }}
          >
      ...
      <main className="admin-main">
        ...
        <header className="admin-topbar">
          ...
          <div className="topbar-breadcrumb">
            ...
            <svg width="16" height="16" fill="none" viewBox="0 0 24 24" stroke="currentColor" className="topbar-separator">
          ...
          <div className="topbar-avatar">
            <div className="avatar-placeholder" style={{ width: '2.25rem', height: '2.25rem', fontSize: '0.875rem' }}>
              A
            </div>
          </div>
        </header>
